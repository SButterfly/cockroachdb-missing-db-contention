...
public abstract class AbstractDBIntegrationTest {
    private static final DockerImageName DEFAULT_IMAGE_NAME = DockerImageName.parse("cockroachdb/cockroach:v23.1.11");

//            Uncomment, if you want to test with posgresql
//    private static final DockerImageName DEFAULT_IMAGE_NAME = DockerImageName.parse("postgres:16.0");
